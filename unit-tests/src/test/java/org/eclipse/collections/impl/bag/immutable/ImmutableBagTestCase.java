...
public abstract class ImmutableBagTestCase extends AbstractRichIterableTestCase
{
    ...
    public void toSortedBag()
    {
        ...
        Verify.assertSortedBagsEqual(MutableSortedTreeBag.newBagWith("1", "2", "2", "3", "3", "3", "4", "4", "4", "4"), sortedBag);

        MutableSortedBag<String> reverse = immutableBag.toSortedBag(Comparator.reverseOrder());
        Verify.assertSortedBagsEqual(MutableSortedTreeBag.newBagWith(Comparator.reverseOrder(), "1", "2", "2", "3", "3", "3", "4", "4", "4", "4"), reverse);
    }
